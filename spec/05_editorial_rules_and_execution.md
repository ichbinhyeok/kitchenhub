# 05 Editorial Rules And Execution
...
## Definition of done
- Local rule pages answer applicability, proof, consequence, and next action
- Every local page has an authority-backed source stack
- CTA logic matches the specific problem state
- The first operator can complete an inspection-prep path without leaving the site confused
