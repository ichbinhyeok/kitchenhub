    ...
    public List<ToolDefinition> allTools() {
        return List.of(
                new ToolDefinition(
                        ...
                        List.of(
                                "Record every pump-out or maintenance action with the service date, service company, gallons removed, and receipt or manifest reference.",
                        ...
                        List.of(
                                new DownloadLink("Download grease log CSV", "/tools/grease-log.csv", "Binder-first worksheet for date, authority, service company, gallons, manifest, receipt, and next-review tracking.")
                        ),
                        List.of(
